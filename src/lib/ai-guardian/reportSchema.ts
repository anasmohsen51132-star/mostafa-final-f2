...
const recommendationSchema = z.object({
  ...
  description: z.string(),
  priority: z.enum(PRIORITY),
  // Task 5 (Recommendation Center) additions — optional so recommendations
  // generated by earlier reports (before these fields existed) still
  // parse and render, just without this extra detail.
...
export type GuardianRootCause = z.infer<typeof rootCauseSchema>;
