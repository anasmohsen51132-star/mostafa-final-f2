    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          fontSize: "clamp(140px,16vw,210px)",
      ...
      <motion.div
        ...
        style={{
          ...
          left: "-1%",
          fontFamily: "Amiri, serif",
          fontSize: "clamp(130px,15vw,190px)",
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle,rgba(45,158,107,0.15),transparent 70%)",
        }}
      ...
      >
        ...
        <motion.div
          ...
          style={{ marginBottom: 14, paddingInline: 16 }}
        >
          <div
            style={{
              width: "clamp(22px,7vw,58px)",
              height: 1,
              background:
                "linear-gradient(to left,transparent,rgba(201,168,76,0.75))",
            }}
          />
          ...
          >
            <span
              style={{
                ...
                lineHeight: 1.25,
                whiteSpace: "nowrap",
                textShadow: "0 2px 14px rgba(201,168,76,0.35)",
              }}
            >
          ...
          <div
            style={{
              ...
              height: 1,
              background:
                "linear-gradient(to right,transparent,rgba(201,168,76,0.75))",
            }}
          />
        </motion.div>
        ...
        >
          {settings?.heroDesc ??
            "انضم إلى آلاف الطلاب في رحلة تعليمية استثنائية تجمع بين الأصالة والحداثة"}
        </motion.p>
